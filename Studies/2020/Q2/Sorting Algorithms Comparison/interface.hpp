...
inline void help()
{
    ...
    std::cout << "\tThe second argument should be \"shell\" or \"quick\" to define algo."
              << std::endl;
    std::cout << "\tAfter you should pass \"ascending\", \"descending\" or \"random\"."
              << std::endl;
    ...
    std::cout << "\tThe second argument should be \"list\" or \"array\" to define base of sequence."
              << std::endl;
