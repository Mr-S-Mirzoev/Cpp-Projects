...
public:
    ...
    char geti(const int& i) const { return (i < strlen(val) ? val[i] : 0); }
    size_t len() const { return strlen(val); }
...
public:
    ...
    char operator[](long i) const { return (i < sz ? this->Nmb[i] : 0); }
...
public:
    ...
    const longNumber re() const { return this->Re; }
    const longNumber im() const { return this->Im; }
    const std::string to_string() const
    {
    ...
    friend const complex operator-(const complex& a) { return complex(-a.Re, -a.Im); }
    friend const complex operator~(const complex& a) { return complex(a.Re, -a.Im); }
    friend complex operator+(complex a1, const complex& a2) { return a1 += a2; }
    friend complex operator-(complex a1, const complex& a2) { return a1 -= a2; }
    friend complex operator*(complex a1, const complex& a2) { return a1 *= a2; }
...
public:
    ...
    complex& operator[](const unsigned i) { return (this->arr[i]); }
    ...
    complex get(int k) const { return arr[k]; }
};
...
public:
    ...
    ~mat() {}
    vec& operator[](const unsigned i) { return (this->a[i]); }
    vec get(const unsigned i) const { return (a[i]); }
