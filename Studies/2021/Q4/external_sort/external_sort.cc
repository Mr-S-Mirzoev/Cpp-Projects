...
struct pair_lower : public std::binary_function<std::pair <unsigned, std::string>, std::pair <unsigned, std::string>, bool>
{
    bool operator()(const std::pair <unsigned, std::string>& __x, const std::pair <unsigned, std::string>& __y) const
...
int main(void)
{
    ...
    while (!should_stop) {
        ...
        std::string supporting_files_name = "extra" + std::to_string(supporting_files_quantity) + ".txt";
    ...
    std::priority_queue<std::pair <unsigned, std::string>, std::vector <std::pair <unsigned, std::string>>, pair_lower> q;
