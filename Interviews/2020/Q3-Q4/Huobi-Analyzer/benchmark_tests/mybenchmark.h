#define InsertVectorsonLists(vector1, vector2, list1, list2, flag)                                 \
    if (flag)                                                                                      \
    {                                                                                              \
        if (!vector1.empty())                                                                      \
...
#define FindMaxonLists(ba_price, ba_amount, bb_price, bb_amount, list1, list2)                     \
...
#define InsertVectorsonMaps(vector1, vector2, map1, map2, flag)                                    \
    if (flag)                                                                                      \
    {                                                                                              \
        if (!vector1.empty())                                                                      \
            for (auto it = vector1.begin(); it != vector1.end(); ++it)                             \
...
#define FindMaxonMaps(ba_price, ba_amount, bb_price, bb_amount, map1, map2)                        \
    ba_price = (*(map1.rbegin())).first;                                                           \
    ba_amount = (*(map1.rbegin())).second;                                                         \
    bb_price = (*(map2.begin())).first;                                                            \
    bb_amount = (*(map2.begin())).second;

#define InsertVectorsonUnorderedMaps(vector1, vector2, map1, map2, flag, bidinv, askinv, bids_min, \
                                     bids_amount, asks_max, asks_amount)                           \
    if (flag)                                                                                      \
    {                                                                                              \
        if (!vector1.empty())                                                                      \
            for (auto it = vector1.begin(); it != vector1.end(); ++it)                             \
...
#define FindMaxonUnorderedMaps(bids_min, bids_amount, asks_max, asks_amount, map1, map2, bidinv,   \
                               askinv)                                                             \
    if (bidinv)                                                                                    \
    {                                                                                              \
        bool not_set = true;                                                                       \
...
#define InsertVectorsonAVL(vector1, vector2, avl1, avl2, flag)                                     \
    if (flag)                                                                                      \
    {                                                                                              \
        if (!vector1.empty())                                                                      \
            for (auto it = vector1.begin(); it != vector1.end(); ++it)                             \
...
#define FindMaxonAVL(ba_price, ba_amount, bb_price, bb_amount, avl1, avl2)                         \
    AVL<double, unsigned long>::node* min = avl1.min();                                            \
    ba_price = min->key;                                                                           \
    ba_amount = min->value;                                                                        \
