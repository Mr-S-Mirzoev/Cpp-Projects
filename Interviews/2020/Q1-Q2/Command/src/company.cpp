...
void Company::set_comp(const Company& c) { dpts = c.dpts; }
...
// modificators
void Company::init_department(const std::string& name, const Department& d) { dpts[name] = d; }
...
void Company::add_worker(const std::string& dpt, const std::string& wrk, const std::string& title,
...
void Company::edit_worker_check(const std::string& dpt, const std::string& wrk,
...
void Company::edit_worker(const std::string& dpt, const std::string& wrk, const std::string& nwrk,
