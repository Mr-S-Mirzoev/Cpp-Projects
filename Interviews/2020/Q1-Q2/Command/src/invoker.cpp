...
void Invoker::addwrk(const std::string& d, const std::string& w, const std::string& t,
                     const unsigned& s)
{
...
void Invoker::editdpt(const std::string& d, const std::string& w, const std::string& n,
