...
Department::Department(const Department& rhs)
    : name(rhs.name), workers(rhs.workers), sum(rhs.sum), q(rhs.q)
{
}

// modificators
void Department::add_worker(const std::string& wrk, const std::string& title,
...
void Department::edit_worker(const std::string& wrk, const std::string& nwrk,
...
void Department::change_name(const std::string& newname) { name = newname; }
...
std::string Department::get_department_name() const { return name; }

bool Department::empty() const { return (name.empty() && workers.empty()); }
