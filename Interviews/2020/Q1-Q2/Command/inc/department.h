...
public:
    ...
    // modificators
    void add_worker(const std::string& wrk, const std::string& title, const unsigned& salary);

    void edit_worker_check(const std::string& wrk, const std::string& newname);
    void edit_worker(const std::string& wrk, const std::string& nwrk, const std::string& nttl,
                     const unsigned& nsal);
