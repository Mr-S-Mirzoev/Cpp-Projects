...
#define ASSERT_EQ(arg1, arg2)                                                                      \
    ++count;                                                                                       \
    if (arg1 != arg2)                                                                              \
        throw RAISE("Test error occured at " __FILE__ ":" LINE_STRING " (" #arg1                   \
...
#define EXPECT_EQ(arg1, arg2)                                                                      \
    ...
    if (arg1 != arg2)                                                                              \
    {                                                                                              \
        std::cout << "Test error occured at " __FILE__ ":" LINE_STRING " (" #arg1                  \
                     " is not equal to " #arg2 "):"                                                \
                  << std::endl;                                                                    \
        std::cout << "\"" << (arg1) << "\""                                                        \
                  << " != "                                                                        \
...
#define TEST_MAIN_END()                                                                            \
    ...
    catch (TestException e) { std::cout << e.what() << std::endl; }                                \
    }